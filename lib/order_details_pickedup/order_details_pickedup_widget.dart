...
import 'order_details_pickedup_model.dart';
export 'order_details_pickedup_model.dart';
...
class _OrderDetailsPickedupWidgetState
  ...
  late OrderDetailsPickedupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderDetailsPickedupModel());
  }
