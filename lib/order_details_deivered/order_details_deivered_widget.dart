...
import 'order_details_deivered_model.dart';
export 'order_details_deivered_model.dart';
...
class _OrderDetailsDeiveredWidgetState
  ...
  late OrderDetailsDeiveredModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderDetailsDeiveredModel());
  }
